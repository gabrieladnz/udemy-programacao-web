...
<body>
    ...
    <section>
        ...
        <h1>Resultado da sua análise de crédito<br></h1>

        <!-- CRIAR O RECEBIMENTO DA INFORMAÇÃO 'NOME' DO FORMULÁRIO... -->
        <?php
        ...
        switch ($pesquisa) {
            ...
            case 'analista de suporte':
                ...
                echo " <p>O analista de suporte é um profissional de TI especialista em tecnologias, constantemente atualizado com novidades mercadológicas de Hardware e Software.</p>
